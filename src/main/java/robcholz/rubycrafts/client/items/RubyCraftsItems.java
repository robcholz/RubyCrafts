package robcholz.rubycrafts.client.items;
...
import robcholz.rubycrafts.RubyCrafts;
import robcholz.rubycrafts.client.armor.RubyCraftsArmorMaterial;
import robcholz.rubycrafts.client.tools.RubyAxeItem;
import robcholz.rubycrafts.client.tools.RubyCraftsToolMaterial;
import robcholz.rubycrafts.client.tools.RubyHoeItem;
import robcholz.rubycrafts.client.tools.RubyPickaxeItem;
...
public class RubyCraftsItems {
    ...
    public static ToolItem RUBY_SWORD = new SwordItem(RubyCraftsToolMaterial.INSTANCE, 9, -2.4F, new Item.Settings().group(ItemGroup.COMBAT));

    public static ToolItem RUBY_PICKAXE = new RubyPickaxeItem(RubyCraftsToolMaterial.INSTANCE, 3, -2.8F, new Item.Settings().group(ItemGroup.TOOLS));
    ...
    public static ToolItem RUBY_HOE = new RubyHoeItem(RubyCraftsToolMaterial.INSTANCE, 1, -1.2F, new Item.Settings().group(ItemGroup.TOOLS));
